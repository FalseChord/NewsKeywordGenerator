...
class NewsFileConverter:
    ...
    def __fetch_news_json_string(self):
        with open(self.__news_file_path, "r", encoding='utf-8') as file:
...
if __name__ == '__main__':
    moe_dict_path = os.path.join("dict", "moe_expand.dict")
    stop_word_dict_path = os.path.join("dict", "stopping_words.dict")
    news_dir = os.path.join("news")
    converted_news_dir = os.path.join("converted_news")
